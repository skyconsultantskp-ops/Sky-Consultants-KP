        ...
        <div className="border-t border-slate-800/50 pt-8">
          <div className="flex flex-col md:flex-row items-center justify-between gap-4">
            ...
            <div className="flex items-center gap-3 flex-wrap justify-center">
              <a
                href="https://web.facebook.com/profile.php?id=61582181151975"
                target="_blank"
                rel="noopener noreferrer"
              ...
              <a
                href="https://www.instagram.com/skyconsultantskp"
                target="_blank"
                rel="noopener noreferrer"
                className="w-9 h-9 rounded-full bg-slate-900/50 border border-slate-800 flex items-center justify-center hover:border-emerald-500/40 hover:bg-emerald-500/10 hover:shadow-lg hover:shadow-emerald-500/20 transition-all duration-300 group"
              ...
              <a
                href="https://www.youtube.com/@SKYConsultantskp"
                target="_blank"
                rel="noopener noreferrer"
                className="w-9 h-9 rounded-full bg-slate-900/50 border border-slate-800 flex items-center justify-center hover:border-emerald-500/40 hover:bg-emerald-500/10 hover:shadow-lg hover:shadow-emerald-500/20 transition-all duration-300 group"
                aria-label="YouTube"
              ...
              <a
                href="https://x.com/sky_consultants"
                target="_blank"
                rel="noopener noreferrer"
                className="w-9 h-9 rounded-full bg-slate-900/50 border border-slate-800 flex items-center justify-center hover:border-emerald-500/40 hover:bg-emerald-500/10 hover:shadow-lg hover:shadow-emerald-500/20 transition-all duration-300 group"
                aria-label="X (Twitter)"
              >
                <svg className="w-4 h-4 text-slate-400 group-hover:text-emerald-400 transition-colors" fill="currentColor" viewBox="0 0 24 24"><path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z"/></svg>
              </a>
              <a
                href="https://www.tiktok.com/@sky.consultants.k"
                target="_blank"
                rel="noopener noreferrer"
                className="w-9 h-9 rounded-full bg-slate-900/50 border border-slate-800 flex items-center justify-center hover:border-emerald-500/40 hover:bg-emerald-500/10 hover:shadow-lg hover:shadow-emerald-500/20 transition-all duration-300 group"
                aria-label="TikTok"
              ...
              <a
                href="https://www.threads.com/@skyconsultantskp"
                target="_blank"
                rel="noopener noreferrer"
                className="w-9 h-9 rounded-full bg-slate-900/50 border border-slate-800 flex items-center justify-center hover:border-emerald-500/40 hover:bg-emerald-500/10 hover:shadow-lg hover:shadow-emerald-500/20 transition-all duration-300 group"
                aria-label="Threads"
              >
                <svg className="w-4 h-4 text-slate-400 group-hover:text-emerald-400 transition-colors" fill="currentColor" viewBox="0 0 24 24"><path d="M12.186 24h-.007c-3.581-.024-6.334-1.205-8.184-3.509C2.35 18.44 1.5 15.586 1.472 12.01v-.017c.03-3.579.879-6.43 2.525-8.482C5.845 1.205 8.6.024 12.18 0h.014c2.746.02 5.043.725 6.826 2.098 1.677 1.29 2.858 3.13 3.509 5.467l-2.04.569c-1.104-3.96-3.898-5.984-8.304-6.015-2.91.022-5.11.936-6.54 2.717C4.307 6.504 3.616 8.914 3.59 12c.025 3.086.718 5.496 2.057 7.164 1.442 1.783 3.639 2.698 6.54 2.717 2.623-.02 4.358-.631 5.8-2.045 1.647-1.613 1.618-3.593 1.09-4.798-.34-.775-.95-1.416-1.76-1.874a7.627 7.627 0 01-.532 2.764c-.467 1.1-1.18 1.987-2.113 2.633-1.009.7-2.2 1.058-3.544 1.065h-.032c-1.63-.009-2.96-.586-3.845-1.67-.82-1.003-1.262-2.37-1.279-3.96.017-1.588.46-2.955 1.28-3.957.886-1.082 2.216-1.66 3.844-1.668h.032c1.635.009 2.953.57 3.814 1.623.4.487.7 1.067.904 1.72l-1.9.633a3.284 3.284 0 00-.5-.975c-.5-.61-1.277-.947-2.318-.953h-.018c-1.015.006-1.792.323-2.31.944-.543.653-.834 1.604-.845 2.733.01 1.13.302 2.08.845 2.732.518.622 1.296.939 2.31.945h.018c.778-.005 1.407-.218 1.869-.634.463-.417.736-1.003.834-1.786.063-.498.049-1.044-.04-1.625l1.883-.395c.177.899.194 1.754.052 2.545 1.39.564 2.468 1.393 3.163 2.472.883 1.37 1.009 3.174.004 4.938-1.065 1.863-2.85 3.068-5.476 3.606A14.614 14.614 0 0112.186 24z"/></svg>
              </a>
              <a
                href="https://wa.me/923075977094"
                target="_blank"
...
function UrgencyBanner() {
  ...
  return (
    <section className="relative bg-gradient-to-r from-emerald-600/10 via-teal-600/5 to-emerald-600/10 border-y border-emerald-500/10">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-3">
        <div className="flex items-center justify-center gap-3 text-sm">
          ...
          <a
            ...
            className="inline-flex items-center gap-1 px-3 py-1 rounded-lg bg-emerald-500/15 text-emerald-400 text-xs font-semibold border border-emerald-500/20 hover:bg-emerald-500/25 transition-colors"
          >
...
function UniversityMarquee() {
  ...
  // Flatten all universities with their country flags
  const allUnis = countries.flatMap((c) =>
    c.universities.map((u) => ({ flag: c.flag, name: u.name, country: c.name }))
  );

  // Split into two rows
  const midPoint = Math.ceil(allUnis.length / 2);
  const row1 = allUnis.slice(0, midPoint);
  const row2 = allUnis.slice(midPoint);

  return (
    <section ref={ref} className="relative py-12 bg-[#060d1b] overflow-hidden">
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 mb-6 text-center">
        <motion.span
          className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-emerald-500/10 border border-emerald-500/20 text-emerald-400 text-xs font-semibold uppercase tracking-wider"
          initial={{ opacity: 0, y: 20 }}
          animate={isInView ? { opacity: 1, y: 0 } : {}}
          transition={{ duration: 0.5 }}
        >
          <Building2 className="w-3 h-3" /> Our Partner Universities
        </motion.span>
      </div>
      ...
      <div className="relative overflow-hidden mb-3">
        ...
        >
          {[...row1, ...row1].map((uni, i) => (
            <div
              key={`r1-${i}`}
              className="flex items-center gap-2 px-4 py-2 rounded-xl bg-slate-900/30 border border-slate-800/50 text-slate-500 text-xs whitespace-nowrap shrink-0"
            >
...
function ScholarshipHighlights() {
  const ref = useRef(null);
  const isInView = useInView(ref, { once: true, margin: '-80px' });
  ...
  const scholarships = [
    {
      ...
      country: 'Italy',
      type: 'Fully Funded',
      description: 'Free tuition + accommodation + stipend (FBR income under 38 Lac/year)',
      isFullyFunded: true,
    },
    {
      flag: '🇹🇷',
      country: 'Turkey',
      type: 'Full/Half Fee Waiver',
    ...
    },
    {
      ...
      country: 'Germany',
      type: 'Free Tuition',
      description: 'Only semester contribution €150-350',
      isFullyFunded: true,
    },
    {
      flag: '🇰🇷',
      ...
      description: 'Tuition + accommodation + stipend (IELTS 5.5+)',
      isFullyFunded: true,
    },
    {
      flag: '🇫🇷',
      country: 'France',
      type: 'Fee Waiver',
      description: 'Half/full fee reduction based on academics',
      isFullyFunded: false,
    },
  ];
    ...
    <section ref={ref} className="relative py-24 bg-[#060d1b]">
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <h2 className="text-3xl md:text-5xl font-extrabold text-white mb-4 tracking-tight">
            Scholarship <span className="bg-gradient-to-r from-emerald-400 to-teal-400 bg-clip-text text-transparent">Highlights</span>
          </h2>
          <p className="text-slate-400 text-lg max-w-lg mx-auto">Top scholarship opportunities to make your study abroad dream affordable.</p>
        </motion.div>
              ...
              <Card className={`bg-slate-900/40 border hover:border-emerald-500/30 hover:shadow-[0_0_25px_-8px_rgba(16,185,129,0.12)] transition-all duration-500 h-full overflow-hidden rounded-2xl relative hover:-translate-y-1 ${
                ...
                <CardContent className="p-6">
                  ...
                  <div className="flex items-center gap-3 mb-4">
                    ...
                    <div>
                      <h3 className="text-white font-bold text-sm">{item.country}</h3>
                      <Badge className={`text-[10px] font-bold ${
                        ...
                        {item.isFullyFunded && <Sparkles className="w-2.5 h-2.5 mr-1" />}
                        {item.type}
                      </Badge>
                    </div>
                  </div>
...
function FAQSection() {
  ...
  const faqs = [
    ...
    },
    {
      ...
      a: 'All educational documents attested by concerned Board/University, IBCC, MOFA, and HEC verification for degrees. We handle the entire attestation process for you.',
    },
    {
    ...
    },
    {
      ...
      a: 'Our consultancy fee ranges from 1.5 Lac to 2.5 Lac depending on the country, which is included in the total package cost. No hidden charges!',
    },
  ];
      ...
      {isVisible && (
        ...
        >
          ...
          <AnimatePresence>
            {showTooltip && (
              <motion.div
                className="absolute bottom-full right-0 mb-3 px-3 py-1.5 rounded-lg bg-slate-800 text-white text-xs font-medium whitespace-nowrap shadow-xl"
          ...
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="relative flex items-center justify-center w-14 h-14 rounded-full bg-green-500 hover:bg-green-400 shadow-lg shadow-green-500/30 transition-colors duration-300"
...
function BackToTop() {
  ...
  return (
    <AnimatePresence>
      {show && (
        <motion.button
          className="fixed bottom-24 right-6 z-50 w-11 h-11 rounded-full bg-slate-800/80 border border-slate-700 flex items-center justify-center text-slate-400 hover:text-white hover:border-emerald-500/40 hover:bg-slate-700/80 backdrop-blur-sm transition-colors shadow-lg"
          initial={{ opacity: 0, scale: 0 }}
          animate={{ opacity: 1, scale: 1 }}
          exit={{ opacity: 0, scale: 0 }}
          transition={{ duration: 0.3 }}
